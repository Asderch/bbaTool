...
VARSAYILAN_ROLLER = {
    "admin": {
        "panel_gor": True, "plan_olustur": True, "plan_gor": True, "plan_sil": True,
        "plan_kapat": True, "kalem_ekle": True, "kalem_toplu_ekle": True,
        "kalem_guncelle": True, "kalem_sil": True, "kalem_gonder": True,
        "kalem_sifirla": True, "toplu_devret": True, "export_pdf": True,
        "export_excel": True, "import_excel": True, "rapor_gor": True,
        "dosya_sil": True, "personel_izin": True, "kullanici_yonet": True,
    ...
    "yonetici": {
        ...
        "kalem_sifirla": True, "toplu_devret": True, "export_pdf": True,
        "export_excel": True, "import_excel": True, "rapor_gor": True,
        "dosya_sil": True, "personel_izin": True, "kullanici_yonet": False,
        "fason_gor": True, "fason_ekle": True, "fason_duzenle": True,
        "fason_import": True, "fason_import_gecmisi": True, "fason_mukerrer": True,
        "fason_sil_tumu": True, "hammadde_gor": True,
        "islem_gecmisi_gor": True,
    ...
    "sevkiyatci": {
        ...
        "kalem_sifirla": True, "toplu_devret": True, "export_pdf": True,
        "export_excel": True, "import_excel": True, "rapor_gor": True,
        "dosya_sil": False, "personel_izin": False, "kullanici_yonet": False,
    ...
    "fasoncu": {
        "panel_gor": False, "plan_olustur": False, "plan_gor": False, "plan_sil": False,
        "plan_kapat": False, "kalem_ekle": False, "kalem_toplu_ekle": False,
        "kalem_guncelle": False, "kalem_sil": False, "kalem_gonder": False,
        "kalem_sifirla": False, "toplu_devret": False, "export_pdf": False,
        "export_excel": False, "import_excel": False, "rapor_gor": False,
        "dosya_sil": False, "personel_izin": False, "kullanici_yonet": False,
        "fason_gor": True, "fason_ekle": True, "fason_duzenle": True,
    ...
    "goruntuleyici": {
        "panel_gor": True, "plan_olustur": False, "plan_gor": True, "plan_sil": False,
        "plan_kapat": False, "kalem_ekle": False, "kalem_toplu_ekle": False,
        "kalem_guncelle": False, "kalem_sil": False, "kalem_gonder": False,
        "kalem_sifirla": False, "toplu_devret": False, "export_pdf": True,
        "export_excel": True, "import_excel": False, "rapor_gor": True,
        "dosya_sil": False, "personel_izin": False, "kullanici_yonet": False,
...
ILK_KULLANICILAR = {
    ...
    "bakar":   {"sifre": "bb5528", "ad": "Berkcan Burak Akar", "rol": "yonetici"},
    "okaraca": {"sifre": "ok1234", "ad": "Özge Karaca",        "rol": "yonetici"},
    "bkonyar": {"sifre": "bk1234", "ad": "Bora Konyar",        "rol": "yonetici"},
    "pgur":    {"sifre": "pg1453", "ad": "Pınar Ecem Gür",     "rol": "yonetici"},
    "hors":    {"sifre": "ho1793", "ad": "Havva Örs",          "rol": "sevkiyatci"},
}
